  ...
  return (
    <div className="min-h-screen bg-white">
      <div className="sticky top-0 bg-white border-b border-gray-100 px-4 py-4 flex items-center gap-3 z-10">
        ...
        <h1 className="text-lg font-black">Emails</h1>
      </div>
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center">
        <div className="text-6xl mb-4">📧</div>
        <h2 className="text-2xl font-black mb-2">Emails</h2>
        <p className="text-gray-500 text-sm">Vos communications par email</p>
